...
// NewFilterForNodeTIDs create a new filter based on flow NodeTID, ANodeTID, BNodeTID
func NewFilterForNodeTIDs(uuids []string) *filters.Filter {
	return filters.NewFilterForIds(uuids, "NodeTID", "ANodeTID", "BNodeTID")
}

// NewFilterForNodes create a new filter based on graph nodes
...
// NewFilterForFlowSet create a new filter based on a set of flows
